...
public class ResourceChecksumTest {
	...
	/**
	 * Verify this test by running the following in the
	 * <code>src/main/test/resources</code> directory:
	 * <p>
	 * <code>
	 * $ md5sum md5me.please
	...
	public void testGenerateMD5Checksum() {
		String checksum = new ResourceChecksum()
				.generateMD5Checksum(new ClassPathResource("md5me.please"));
