...
public interface NomadDeploymentPropertyKeys {
	...
	/**
	 * A flag to indicate whether the tags/labels that enable Fabio to configure routing
	 * are added or not. Specify a value of <code>true</code> to enable adding the URL
	 * prefix tags. See https://github.com/eBay/fabio/wiki/Quickstart
	 */
	String NOMAD_EXPOSE_VIA_FABIO = "spring.cloud.deployer.nomad.fabio.expose";

	/**
	 * The hostname that will be exposed via Fabio. If no hostname is provided, the
	 * deploymentId will be used. See https://github.com/eBay/fabio/wiki/Quickstart
	 */
	...
	/**
	 * The
	 * <a href="https://www.nomadproject.io/docs/jobspec/json.html#MemoryMB">memory</a>
	 * required in MB.
	 */
	String NOMAD_RESOURCES_MEMORY = "spring.cloud.deployer.nomad.memory";

	/**
	 * Environment variables passed at deployment time. This is to cater for adding
	 * variables like JAVA_OPTS to supported deployer types.
	 */
	...
	/**
	 * Comma separated list of Docker volumes in the form
	 * <code>host_path:container_path</code>. These volumes will be added to <b>all</b>
	 * apps deployed.
	 * <p>
	...
	/**
	 * Ephemeral disk migrate flag. Valid values are <code>true</code> or
	 * <code>false</code>. See
	...
	/**
	 * Ephemeral disk sticky flag. Valid values are <code>true</code> or
	 * <code>false</code>. See
	 * https://www.nomadproject.io/docs/job-specification/ephemeral_disk.html
	 */
	 ...
	 * <code>spring.cloud.deployer.nomad.ephemeralDisk.size=300</code>, which represents a
	 * size of 300MB. See
	 * https://www.nomadproject.io/docs/job-specification/ephemeral_disk.html
	 */
