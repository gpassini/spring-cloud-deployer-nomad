...
/**
 * EntryPoint style used for a Docker image. Affects how app properties are passed in. For
 * exec app properties should be passed in as command line args, for shell they should be
 * passed in as environment variables and for boot they should be passed in using a
